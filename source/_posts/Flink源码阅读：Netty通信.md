...
![NettyRequestPartition](https://res.cloudinary.com/dxydgihag/image/upload/v1767668875/Blog/flink/19/NettyRequestPartition.png)
...
![NettyServerHandler](https://res.cloudinary.com/dxydgihag/image/upload/v1767684663/Blog/flink/19/NettyServerHandler.png)
...
![NettyClientHandler](https://res.cloudinary.com/dxydgihag/image/upload/v1767689791/Blog/flink/19/NettyClientHandler.png)
...
![LocalBufferPool](https://res.cloudinary.com/dxydgihag/image/upload/v1767694630/Blog/flink/19/LocalBufferPoolRecycle.png)

另一种是 RemoteInputChannel 独占的 buffer 队列释放 buffer 时，会触发 Credit 更新。

![BufferManager](https://res.cloudinary.com/dxydgihag/image/upload/v1767700038/Blog/flink/19/BufferManagerRecycle.png)
