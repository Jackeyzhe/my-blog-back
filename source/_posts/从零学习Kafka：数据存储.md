...
date: 2026-01-30 10:23:16
tags: Kafka
---

不知道有没有朋友和我一样，虽然了解 Kafka 的逻辑存储，例如 Broker、Topic、Partition 这些概念，但是对于底层数据是如何存储还是比较模糊。这样聊起来 Kafka 数据存储时总有种一知半解的感觉。今天我们就一起来看一下 Kafka 底层数据到底是怎么存储的。<!-- more -->
...
![segment_size](https://res.cloudinary.com/dxydgihag/image/upload/v1769790300/Blog/Kafka/2/kafka_segment_size.png)
...
![cluster_started](https://res.cloudinary.com/dxydgihag/image/upload/v1769790383/Blog/Kafka/2/cluster_started.png)
...
![category](https://res.cloudinary.com/dxydgihag/image/upload/v1769791316/Blog/Kafka/2/catagory.png)
...
![log_data](https://res.cloudinary.com/dxydgihag/image/upload/v1769952332/Blog/Kafka/2/log_data.png)
...
![index_data](https://res.cloudinary.com/dxydgihag/image/upload/v1769953138/Blog/Kafka/2/index_data.png)
...
![timeindex_data](https://res.cloudinary.com/dxydgihag/image/upload/v1769953464/Blog/Kafka/2/timeindex_data.png)
